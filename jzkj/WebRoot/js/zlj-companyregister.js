...
window.onload = function() {
	...
	var regLinkman = document.getElementById('regLinkman');// 联系人输入框
	var regLinkmanRemind = document.getElementById('regLinkmanRemind');// 联系人提示框
	...
	regLinkman.onfocus = function() {
		...
		regLinkman.style.color = '#555555';
	}
	regLinkman.onblur = function() {
		regLinkman.style.border = 'solid 1px #CCC';
		regLinkman.style.color = '#999999';
		var registerName = /^[\u2E80-\uFE4F]{2,18}$/;
		var strLength = getStrLength(regLinkman.value);
		if (registerName.test(regLinkman.value)) {
			regLinkmanRemind.style.display = 'none';
			regLinkmanRemind.style.border = 'solid 1px #CCC';
			regLinkmanRemind.style.color = '#999999';
			regLinkmanRemind.style.background = 'solid 1px #F7F7F7';
			return true;
		} else {
			regLinkmanRemind.style.display = 'block';
			regLinkmanRemind.style.border = 'solid 1px #FFBDBE';
			regLinkmanRemind.style.background = 'solid 1px #FFEBEB';
			regLinkmanRemind.style.color = '#FF0000';
			return false;
		}
	}
	...
	regLinkPhone.onblur = function() {
		...
		var strLength = getStrLength(regLinkPhone.value);
