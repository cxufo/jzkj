...
function HS_calender(){
    ...
    if (typeof(arguments[0])=="string"){
        ...
        var date = DateValueTemp.substr(6,2);   // alert(year+" "+month+"
												// "+date);
    ...
    var CalenderTitle = "\";
    CalenderTitle += "<span style="color:#FFCC00;">"+thisDate.getFullYear()+"年</span>"
    ...
    CalenderTitle += "<span style="color:#FFCC00;">"+(parseInt(thisDate.getMonth())+1)+"月</span> "; 
    ...
    CalenderTitle += "<span style="color:#FFCC00;"+isShowTime+"">"+(parseInt(thisDate.getHours()))+"时</span> "; 
    ...
    CalenderTitle += "<span style="color:#FFCC00;margin:0 -2px;"+isShowTime+"">"+0+"分</span> "; 
    ...
    var lis = "";
    for (i=0; i<lastmonthdate; i++){="" last="" month's="" date="" lis="<li class='lastMonthDate'>" +lastmonthenddate+"<="" li="">" + lis;
        lastMonthEndDate--;
    }
