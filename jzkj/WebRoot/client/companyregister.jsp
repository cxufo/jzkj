...
<script src="<%=registerBasePath%>js/zlj-companyregister.js"></script>
...
filter:Alpha(opacity=100); /* IE8 以及更早的浏览器 */"
	...
	<div id="register-frame" class="register-frame"
		...
		<form action="" method="post" id="comRegisterForm">
			...
			<div id="comName" class="regItem">
				<div class="regLable">
					<b class="redStar">*</b>联系人：
				</div>
				<div class="regInput">
					<input id="regLinkman" name="regName" class="regtext" type="text">
				</div>
				<div class="regRemind" id="regLinkmanRemind">请填写您的联系称呼，方便我们与您进行联系</div>
			</div>
			<div id="comName" class="regItem">
				<div class="regLable">
